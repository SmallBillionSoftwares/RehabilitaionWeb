...
$sql="INSERT INTO pending_enrol (name,phone,drug,location,gender)VALUES ('$fullName','$phoneNumber','$drugAbused'
,'$location','$gender')";
...
<!-- start enrol form -->
<form action="enrol.php" method="post" style="margin: auto; width: 50%;" class="main-form needs-validation" >
...
<div class="<?php if(isset($label)) {echo $label;} ?>"><?php if(isset($message)) {echo $message;} ?></div>
	...
	<button type="submit" name="enrolbtn" class="btn btn-primary">Submit</button>
</form>
<!-- end enrol form -->
</div>
